...
class TestBedrockClaudeRequest:
    ...
    def test_claude_request_with_tools(self):
        ...
        request = BedrockClaudeRequest(
            max_tokens=1000,
            messages=[BedrockMessage(role="user", content="What's the weather?")],
            tools=[tool],
    ...
    def test_claude_request_with_complex_content(self):
        ...
        request = BedrockClaudeRequest(max_tokens=1000, messages=[message])
    ...
    def test_claude_request_validation_errors(self):
        ...
        # Empty messages
        with pytest.raises(ValidationError):
            BedrockClaudeRequest(max_tokens=1000, messages=[])
...
class TestBedrockTitanRequest:
    ...
    def test_valid_titan_request(self):
        ...
        config = BedrockTitanConfig(maxTokenCount=1000, temperature=0.7, topP=0.9)
        request = BedrockTitanRequest(
            inputText="Hello, how are you?", textGenerationConfig=config
        )
    ...
    def test_titan_request_with_stop_sequences(self):
        ...
        config = BedrockTitanConfig(maxTokenCount=1000, stopSequences=["Human:", "AI:"])
        request = BedrockTitanRequest(inputText="Hello", textGenerationConfig=config)
...
class TestBedrockResponses:
    ...
    def test_claude_response_creation(self):
        ...
        response = BedrockClaudeResponse(
            ...
            type="message",
            role="assistant",
            content=[BedrockContentBlock(type="text", text="Hello there!")],
