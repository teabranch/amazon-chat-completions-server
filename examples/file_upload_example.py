...
def upload_file_example():
    ...
    sample_data = [
        ...
        {"prompt": "What is 2 + 2?", "completion": "2 + 2 equals 4."},
        {
            ...
            "completion": "William Shakespeare wrote Romeo and Juliet.",
        },
    ]
    ...
    try:
        ...
        with open(temp_file, "rb") as f:
            files = {"file": (temp_file.name, f, "application/jsonl")}
            data = {"purpose": "fine-tune"}

            # Make the upload request
            response = requests.post(
                f"{server_url}/v1/files", headers=headers, files=files, data=data
            )
