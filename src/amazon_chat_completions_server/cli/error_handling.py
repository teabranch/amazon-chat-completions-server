...
class CLIErrorHandler:
    ...
    def _handle_not_found(self, error: requests.HTTPError):
        ...
        self.console.print("The requested resource was not found. Please check the model name or server URL.")

    def _handle_rate_limit(self, error: requests.HTTPError):
        self.console.print("[bold red]Rate Limit Error[/bold red]")
        self.console.print("Too many requests. Please wait a moment before trying again.")
    ...
    def _handle_generic_error(self, error: requests.HTTPError):
        self.console.print(f"[bold red]API Error ({error.response.status_code})[/bold red]")
    ...
    def handle_connection_error(self, error: requests.ConnectionError):
        ...
        self.console.print("Could not connect to the server. Please check your internet connection and server URL.")
