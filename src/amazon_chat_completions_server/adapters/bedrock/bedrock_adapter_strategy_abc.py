...
from ...core.models import Message, ChatCompletionRequest, ChatCompletionResponse, ChatCompletionChunk, Usage
...
class BedrockAdapterStrategy(ABC):
    ...
    def _map_finish_reason(self, provider_reason: str) -> str:
        ...
        return mapping.get(provider_reason, provider_reason) # Return original if not in map

    def _extract_system_prompt_and_messages(self, messages: List[Message]) -> Tuple[Optional[str], List[Message]]:
